...
package automatone.command.argument;
...
import automatone.api.command.datatypes.IDatatype;
import automatone.api.command.datatypes.IDatatypeContext;
import automatone.api.command.datatypes.IDatatypeFor;
import automatone.api.command.datatypes.IDatatypePost;
...
import automatone.api.command.exception.CommandNotEnoughArgumentsException;
import automatone.api.command.exception.CommandTooManyArgumentsException;

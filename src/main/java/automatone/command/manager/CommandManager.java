...
package automatone.command.manager;
...
import automatone.api.command.exception.CommandUnhandledException;
import automatone.api.command.exception.ICommandException;
...
import automatone.command.argument.ArgConsumer;
import automatone.command.argument.CommandArguments;
import automatone.command.defaults.DefaultCommands;

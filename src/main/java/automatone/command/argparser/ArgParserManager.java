...
package automatone.command.argparser;

import automatone.api.command.argparser.IArgParser;
import automatone.api.command.argparser.IArgParserManager;
...
import automatone.api.command.exception.CommandNoParserForTypeException;

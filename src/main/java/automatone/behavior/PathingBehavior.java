...
import automatone.api.behavior.IPathingBehavior;
import automatone.api.event.events.*;
import automatone.api.pathing.calc.IPath;
...
import automatone.api.utils.PathCalculationResult;
import automatone.api.utils.interfaces.IGoalRenderPos;
import automatone.pathing.calc.AStarPathFinder;
import automatone.pathing.calc.AbstractNodeCostSearch;
import automatone.pathing.movement.CalculationContext;
import automatone.pathing.movement.MovementHelper;
import automatone.pathing.path.PathExecutor;
import automatone.utils.PathingCommandContext;
import automatone.utils.pathing.Favoring;
    ...
    private void tickPath() {
        ...
        synchronized (pathPlanLock) {
            ...
            synchronized (pathCalcLock) {
                ...
                if (ticksRemainingInSegment(false).getAsDouble() < Baritone.settings().planningTickLookahead.value) {

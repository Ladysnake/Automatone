...
public final class RayTraceUtils {
    ...
    public static Vec3d inferSneakingEyePosition(Entity entity) {
        return new Vec3d(entity.getX(), entity.getY() + ((IEntity) entity).automatone$invokeGetEyeHeight(EntityPose.CROUCHING, entity.getDimensions(EntityPose.CROUCHING)), entity.getZ());
    }
}
